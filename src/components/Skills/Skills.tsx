...
export default function Skills(){
    return (
        <div className="w-[500px] h-full bg-gradient-to-br from-[#E3E9EC] to-[#FEFFFF] flex p-5 rouded-lg shadow-xl">
            <div className="flex flex-col w-full p-5">
                <div className="flex items-center gap-3 text-left"><div className="text-[#FF014F]">02.</div><div className="text-4xl font-black">Skills 🛠️</div></div>
                <Separator />
