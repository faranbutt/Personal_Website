...
export default function About(){
    return (
        <div className="w-[500px] h-96 bg-gradient-to-br from-[#E3E9EC] to-[#FEFFFF] flex p-5">
            <div className="flex flex-col">
                <div className="flex items-center gap-3 text-left"><div className="text-[#FF014F]">01.</div><div className="text-4xl">About Me</div></div>
                <Separator />
